        ...
        @else
            <div class="card shadow">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary" style="font-size: 16px;">Hasil Lomba Semaphore & Morse</h6>
                    <div>
                        <a href="{{ route('pdf.lomba-sms') }}" class="btn btn-primary mt-4 mr-2" style="font-size: 11px;">
                            <i class="fas fa-file-pdf"></i> Ekspor PDF
                        </a>
                        <a href="{{ route('excel.lomba-sms') }}" class="btn btn-success mt-4" style="font-size: 11px;">
