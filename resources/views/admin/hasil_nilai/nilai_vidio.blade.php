    ...
    <div class="col-sm-12 ms-2 me-2 mt-4" style="font-size: 11px;">
        ...
        <div class="card shadow mb-4 mt-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary" style="font-size: 11px;">Lihat Hasil Penilaian Vidio</h6>
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" id="putra-tab" data-toggle="tab" href="#putra" role="tab" aria-controls="putra" aria-selected="true">Vidio</a>
                    </li>
                </ul>
                <!-- Tombol Ekspor -->
                <div>
                    <a href="{{ route('exportPDFVidio', ['tab' => 'penilaian_vidio']) }}" class="btn btn-danger btn-md" title="Export PDF" style="font-size: 11px;">
                        <i class="fas fa-file-pdf"></i> Export PDF
                    </a>
                    <a href="{{ route('exportExcelVidio') }}" class="btn btn-success btn-md" title="Export Excel" style="font-size: 11px;">
