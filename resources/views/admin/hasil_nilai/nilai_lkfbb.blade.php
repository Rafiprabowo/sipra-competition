    ...
    <div class="col-sm-12 ms-2 me-2" style="font-size: 11px;">
        ...
        <div class="card shadow">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary" style="font-size: 16px;">Lihat Hasil Penilaian Lkfbb</h6>
                ...
                <!-- Tombol Ekspor -->
                <div>
                    <a href="{{ route('exportPDFLkfbb', ['tab' => 'putra']) }}" class="btn btn-danger btn-md" title="Export PDF Putra" style="font-size: 11px;">
                        <i class="fas fa-file-pdf"></i> Export PDF Putra
                    </a>
                    <a href="{{ route('exportPDFLkfbb', ['tab' => 'putri']) }}" class="btn btn-warning btn-md" title="Export PDF Putri" style="font-size: 11px;">
                        <i class="fas fa-file-pdf"></i> Export PDF Putri
                    </a>
                    <a href="{{ route('exportExcelLkfbb') }}" class="btn btn-success btn-md" title="Export Excel" style="font-size: 11px;">
