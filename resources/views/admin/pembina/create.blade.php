                ...
                <form action="{{ route('admin.pembina.store') }}" method="POST">
                    ...
                    <div class="container-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_gudep') is-invalid @enderror" id="nama_gudep" name="nama_gudep" value="{{ old('nama_gudep') }}" required>
                            @error('nama_gudep')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" required>
                            @error('tanggal_lahir')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
