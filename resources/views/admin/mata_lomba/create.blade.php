    ...
    <div class="col-sm-12 ms-2 me-2 mt-2">
        ...
        <div class="card shadow mb-4" style="font-size: 11px;">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="font-size: 11px;">Form Tambah Mata Lomba</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.mata-lomba.store') }}" method="POST">
                    ...
                    <div class="container-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('jumlah_peserta') is-invalid @enderror" id="jumlah_peserta" name="jumlah_peserta" value="{{ old('jumlah_peserta') }}" style="font-size: 11px;" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" rows="4" style="font-size: 11px;" required>{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
