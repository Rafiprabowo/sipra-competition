...
@section('content')
    <div class="container-fluid" style="font-size: 12px;">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Bank Soal Tes Pengetahuan Kepramukaan</li>
            </ol>
        </nav>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h5>Bank Soal Tes Pengetahuan Kepramukaan</h5>
                <div class="d-flex">
                    <!-- Tombol Import Excel -->
                            ...
                            @foreach($tpk_questions as $question)
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <a href="{{ route('soal-tpk.edit', $question->id) }}" class="btn btn-warning btn-sm mr-1" data-toggle="tooltip" data-placement="top" title="Edit">
    ...
    <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{route('import.soal-tpk')}}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    @foreach($tpk_questions as $question)
        <div class="modal fade" id="deleteModal{{$question->id}}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{$question->id}}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('soal-tpk.destroy', $question->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <div class="modal-header">
