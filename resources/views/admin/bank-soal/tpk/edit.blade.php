    ...
    <div class="container-fluid" style="font-size: 12px;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('soal-tpk.index') }}">Bank Soal Tes Pengetahuan Kepramukaan</a></li>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('soal-tpk.update', $tpk_question->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
