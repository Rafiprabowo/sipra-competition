    ...
    <div class="container-fluid" style="font-size: 11px;">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('soal-sms.index') }}">SMS Questions</a></li>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{ route('soal-sms.index') }}" class="btn btn-secondary btn-sm" title="Back to List">
                    <i class="fas fa-arrow-left"></i>
                </a>
            </div>
            <div class="card-body">
                <form action="{{ route('soal-sms.update', $smsQuestion->id) }}" method="POST">
                    @csrf
                    @method('PUT')
