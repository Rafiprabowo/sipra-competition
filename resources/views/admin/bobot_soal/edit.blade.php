...
@section('content')
    <div class="col-sm-12 ms-2 me-2 mt-2">
        <h1 class="h3 mb-4 text-gray-800">Edit Bobot Soal</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Form Edit Bobot Soal</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.bobot-soal.update', $bobotSoal->id) }}" method="POST">
                    ...
                    <div class="container-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kriteria_nilai') is-invalid @enderror" id="kriteria_nilai" name="kriteria_nilai" value="{{ old('kriteria_nilai', $bobotSoal->kriteria_nilai) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('bobot_soal') is-invalid @enderror" id="bobot_soal" name="bobot_soal" value="{{ old('bobot_soal', $bobotSoal->bobot_soal) }}" required>
                            @error('bobot_soal')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
