...
<div class="container" style="font-size: 11px;">
    <h2 class="mb-4" style="font-size: 11px;">Form Penilaian Lkfbb</h2>
    <!-- Form Penilaian -->
    <form action="{{ route('penilaian-lkfbb.store') }}" method="POST" id="penilaianForm">
        @csrf
        <!-- Filter -->
        <div class="mb-4">
            <!-- Filter Pangkalan -->
...
<script>
    $(document).ready(function () {
        $('#filter-pangkalan').change(function () {
            ...
            let url = `/juri/regu/lkfbb/${pangkalan_id}`;
        ...
        $('#regu_pembina_id').change(function () {
            ...
            let url = `/juri/peserta/lkfbb/${regu_id}`;
            $.ajax({
                url: url,
                method: 'GET',
                success: function(response) {
